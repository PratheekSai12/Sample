    ...
    return (
        ...
        <div className="inner-container1">
            <form className="d-flex flex-column" onSubmit={registerUser} >
                ...
                <input className='form-control' onChange={changeUn} type="text" id="userName" onBlur={checkUn} placeholder='Create Username'/>
                </div>
                <div className="error">{unError}</div>
                <div class="form-group">
                <label className='form-log'><strong>Create Password </strong></label>
                <input className='form-control' type="password" onChange={changePass}  onBlur={checkPass} placeholder='Create Password'/>
